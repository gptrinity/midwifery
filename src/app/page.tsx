...
import { BookOpen, Target, Bot, FileText, ArrowRight, Brain, ShieldCheck } from "lucide-react";
  ...
  const features = [
    {
      ...
      desc: `${questionCount}+ original questions across 7 subjects, from newbie to professional level, organised topic by topic.`,
      icon: BookOpen,
      href: "/subjects",
      cta: "Browse subjects",
    },
    ...
    <div className="space-y-8">
      <section className="card relative overflow-hidden p-8 text-white">
        ...
        <div className="relative">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-relaxed text-brand-50/90">
            {subjectCount} subjects, {questionCount}+ past-style questions broken down topic by topic, mock exams,
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            >
              {user ? "Start a practice session" : "Create a free account"}
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="card p-6">
        <div className="mb-4 flex items-center justify-between">
          ...
          <Link href="/practice" className="text-sm font-semibold text-brand-600 hover:underline">
            More practice →
          </Link>
        </div>
